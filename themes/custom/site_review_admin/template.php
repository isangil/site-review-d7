 ...
 */
function site_review_admin_date_combo($variables) {
 ...
 */
function site_review_admin_preprocess_views_exposed_form(&$vars) {
  $wrap_button = false;
 ...
 */
function site_review_admin_views_bulk_operations_form_alter(&$form, &$form_state, $vbo) {
